...
The first screen of each section makes an API call after the user has input 3 or more characters. A dropdown menu will subsequently display a **scrollable list of suggestions** to the user based on the response received  from the API for the given keyword.
<p align="center">
